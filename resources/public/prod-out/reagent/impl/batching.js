...
var c_12083 = (a[i]);
if(cljs.core.truth_((c_12083["cljsIsDirty"]))){
(c_12083["forceUpdate"])();
} else {
}
...
var G__12086 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__12086) : reagent.impl.batching.next_tick.call(null,G__12086));
}
});
...
var G__12088 = c;
var G__12088__$1 = (((G__12088 == null))?null:(G__12088["props"]));
if((G__12088__$1 == null)){
return null;
} else {
return (G__12088__$1["argv"]);
}
});
...
var G__12090_12091 = (c["cljsRatom"]);
if((G__12090_12091 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12090_12091);
}
