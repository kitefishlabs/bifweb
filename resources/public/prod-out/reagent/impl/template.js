...
var G__12191 = o;
(G__12191[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_12195 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_12195))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_12195)].join(''):class$));
} else {
}
...
var G__12198 = jsprops;
(G__12198["defaultValue"] = value);

(G__12198["onChange"] = ((function (G__12198,v,value,on_change){
return (function (p1__12196_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12196_SHARP_);
});})(G__12198,v,value,on_change))
);
...
var vec__12200 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12200,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12200,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12200,(2),null);
...
var temp__4659__auto__ = (function (){var G__12204 = cljs.core.meta(v);
if((G__12204 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__12204);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__12206_12207 = v;
var G__12206_12208__$1 = (((G__12206_12207 == null))?null:reagent.impl.template.key_from_vec(G__12206_12207));
if((G__12206_12208__$1 == null)){
} else {
(jsprops["key"] = G__12206_12208__$1);
}
...
var G__12212 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12212) : reagent.impl.template.as_element.call(null,G__12212));
} else {
var p = (function (){var temp__4659__auto__ = (function (){var G__12213 = cljs.core.meta(argv);
if((G__12213 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__12213);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__12214 = (((jsprops == null))?{}:jsprops);
(G__12214["key"] = key);
...
var G__12215 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12215;
continue;
}
} else {
...
var n__7059__auto___12216 = a.length;
var i_12217 = (0);
while(true){
if((i_12217 < n__7059__auto___12216)){
(a[i_12217] = reagent.impl.template.as_element((a[i_12217])));

var G__12218 = (i_12217 + (1));
i_12217 = G__12218;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7059__auto___12219 = a.length;
var i_12220 = (0);
while(true){
if((i_12220 < n__7059__auto___12219)){
var val_12221 = (a[i_12220]);
if((cljs.core.vector_QMARK_(val_12221)) && ((reagent.impl.template.key_from_vec(val_12221) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12220] = reagent.impl.template.as_element(val_12221));

var G__12222 = (i_12220 + (1));
i_12220 = G__12222;
continue;
} else {
}
...
var G__12224 = (cljs.core.count(argv) - first_child);
switch (G__12224) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12224){
