...
return (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,"faq-topic"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h2,topic], null),(function (){var iter__6928__auto__ = ((function (topic,quests){
return (function bifweb$pages$faq$markup_topic_$_iter__13244(s__13245){
return (new cljs.core.LazySeq(null,((function (topic,quests){
return (function (){
var s__13245__$1 = s__13245;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__13245__$1);
if(temp__4657__auto__){
var s__13245__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__13245__$2)){
var c__6926__auto__ = cljs.core.chunk_first(s__13245__$2);
var size__6927__auto__ = cljs.core.count(c__6926__auto__);
var b__13247 = cljs.core.chunk_buffer(size__6927__auto__);
if((function (){var i__13246 = (0);
while(true){
if((i__13246 < size__6927__auto__)){
var quest = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__6926__auto__,i__13246);
cljs.core.chunk_append(b__13247,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bifweb.pages.faq.markup_question,quest], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$id,quest], null)], null)));

var G__13250 = (i__13246 + (1));
i__13246 = G__13250;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13247),bifweb$pages$faq$markup_topic_$_iter__13244(cljs.core.chunk_rest(s__13245__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13247),null);
}
} else {
var quest = cljs.core.first(s__13245__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bifweb.pages.faq.markup_question,quest], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$id,quest], null)], null)),bifweb$pages$faq$markup_topic_$_iter__13244(cljs.core.rest(s__13245__$2)));
}
} else {
return null;
}
...
return (function (){
new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h1,"FAQs"], null);

return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$ul,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,"faq-topics-list"], null),(function (){var iter__6928__auto__ = (function bifweb$pages$faq$faq_page_$_iter__13257(s__13258){
return (new cljs.core.LazySeq(null,(function (){
var s__13258__$1 = s__13258;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__13258__$1);
if(temp__4657__auto__){
var s__13258__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__13258__$2)){
var c__6926__auto__ = cljs.core.chunk_first(s__13258__$2);
var size__6927__auto__ = cljs.core.count(c__6926__auto__);
var b__13260 = cljs.core.chunk_buffer(size__6927__auto__);
if((function (){var i__13259 = (0);
while(true){
if((i__13259 < size__6927__auto__)){
var topic = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__6926__auto__,i__13259);
cljs.core.chunk_append(b__13260,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bifweb.pages.faq.markup_topic,topic], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(topic)], null)));

var G__13263 = (i__13259 + (1));
i__13259 = G__13263;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13260),bifweb$pages$faq$faq_page_$_iter__13257(cljs.core.chunk_rest(s__13258__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13260),null);
}
} else {
var topic = cljs.core.first(s__13258__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bifweb.pages.faq.markup_topic,topic], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(topic)], null)),bifweb$pages$faq$faq_page_$_iter__13257(cljs.core.rest(s__13258__$2)));
}
} else {
return null;
}
